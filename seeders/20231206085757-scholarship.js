...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    },
    {
      ...
      jenis_beasiswa: 'Swasta',
      tenggat_waktu: new Date('2023-12-15'),
      deskripsi: 'Beasiswa Bank Indonesia merupakan beasiswa prestasi yang diberikan oleh Bank Indonesia untuk mahasiswa dengan jenjang Pendidikan Strata 1 (S1) di berbagai perguruan tinggi baik perguruan tinggi negeri dan swasta.',
      link: 'http://bbri.id/scholarship2023',
      createdAt: new Date(),
      updatedAt: new Date(),
    },
